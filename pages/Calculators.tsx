...
const Calculators: React.FC = () => {
  ...
  const tabs = [
    { id: 'compound', label: 'Plano de Metas', pro: true }, 
                ...
                <div className={cardClass}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                             ...
                             <div className="p-4 bg-slate-50 dark:bg-[#000000] rounded-xl font-mono font-bold text-slate-900 dark:text-white border border-slate-200 dark:border-[#2C2C2E] text-lg">R$ {calculationBankroll.toFixed(2)}</div>
                        </div>
                        <div>
                             ...
                             <select value={kellyFraction} onChange={e => setKellyFraction(e.target.value)} className="w-full p-4 bg-slate-50 dark:bg-[#000000] border border-slate-200 dark:border-[#2C2C2E] text-slate-900 dark:text-white rounded-xl font-bold text-sm outline-none focus:border-indigo-500">
                        ...
                        <div>
                             <label className="text-[10px] font-bold text-slate-500 dark:text-[#8E8E93] uppercase block mb-2 tracking-widest">Sua Odd</label>
