      ...
      <section id="features" className="py-24 px-6 bg-[#020617] relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[350px]">
            ...
            <div className="md:col-span-6 lg:col-span-8 bg-[#0b101e] border border-white/5 rounded-[2rem] overflow-hidden group hover:border-emerald-500/30 transition-all duration-500 flex flex-col md:flex-row">
              {/* Coluna de Texto */}
              <div className="p-8 md:p-10 flex flex-col justify-between relative z-20 md:w-5/12 bg-gradient-to-b md:bg-gradient-to-r from-[#0b101e] to-transparent lg:via-[#0b101e]">
                 <div>
              ...
              {/* Coluna da Imagem */}
              <div className="relative flex-1 h-64 md:h-auto overflow-hidden md:rounded-tl-2xl border-t md:border-l border-white/10">
                 <img 
                 ...
                 />
                 {/* Overlay para mobile */}
                 <div className="absolute inset-0 bg-gradient-to-t from-[#0b101e] via-transparent to-transparent md:hidden z-10 pointer-events-none" />
              </div>
            </div>
            ...
            <div className="md:col-span-3 lg:col-span-4 bg-[#0b101e] border border-white/5 rounded-[2rem] relative overflow-hidden group hover:border-purple-500/30 transition-all duration-500">
               <div className="absolute inset-0 p-8 pb-32 z-20 pointer-events-none flex flex-col">
                  <div className="w-10 h-10 bg-purple-500/10 rounded-lg flex items-center justify-center mb-4 text-purple-500 border border-purple-500/20 shrink-0">
                    <BrainCircuit size={20} />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2 shrink-0">Calculadoras Pro</h3>
                  <p className="text-slate-400 text-sm">
                    Arbitragem, Dutching, Kelly e +EV integradas ao fluxo de aposta.
                  </p>
               </div>
               
               <div className="absolute bottom-0 right-0 w-full h-[55%] z-10 transform group-hover:scale-105 transition-transform duration-500 shadow-2xl rounded-tl-2xl overflow-hidden border-t border-l border-white/10">
                 <img 
               ...
               <div className="absolute inset-0 bg-gradient-to-b from-[#0b101e] via-[#0b101e]/50 to-transparent z-15 pointer-events-none" />
            </div>
            ...
            <div className="md:col-span-3 lg:col-span-4 bg-[#0b101e] border border-white/5 rounded-[2rem] relative overflow-hidden group hover:border-blue-500/30 transition-all duration-500">
               <div className="absolute inset-0 p-8 pb-32 z-20 pointer-events-none flex flex-col">
                  <div className="w-10 h-10 bg-blue-500/10 rounded-lg flex items-center justify-center mb-4 text-blue-500 border border-blue-500/20 shrink-0">
                    <BarChart3 size={20} />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2 shrink-0">Histórico Auditável</h3>
                  <p className="text-slate-400 text-sm">
                    Filtros avançados e visualização clara de cada operação pendente ou finalizada.
                  </p>
               </div>
               
               <div className="absolute -bottom-5 -right-5 w-[110%] h-[55%] z-10 transform rotate-[-2deg] group-hover:rotate-0 transition-transform duration-500 shadow-2xl rounded-tl-2xl overflow-hidden border-t border-l border-white/10">
                 <img 
            ...
            <div className="md:col-span-6 lg:col-span-8 bg-[#0b101e] border border-white/5 rounded-[2rem] overflow-hidden group hover:border-orange-500/30 transition-all duration-500 flex flex-col md:flex-row">
              <div className="p-8 md:p-10 flex flex-col justify-between relative z-20 md:w-5/12 bg-gradient-to-b md:bg-gradient-to-r from-[#0b101e] to-transparent lg:via-[#0b101e]">
                 <div>
             ...
             {/* 5. CALENDAR & MINDSET (Square - Padding inferior) */}
             <div className="md:col-span-3 lg:col-span-4 bg-[#0b101e] border border-white/5 rounded-[2rem] relative overflow-hidden group hover:border-cyan-500/30 transition-all duration-500">
               <div className="absolute inset-0 p-8 pb-32 z-20 pointer-events-none flex flex-col">
                  <div className="w-10 h-10 bg-cyan-500/10 rounded-lg flex items-center justify-center mb-4 text-cyan-500 border border-cyan-500/20 shrink-0">
                    <TrendingUp size={20} />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2 shrink-0">Performance Diária</h3>
                  <p className="text-slate-400 text-sm">
                    Calendário de Greens e Reds para visualizar sua consistência.
                  </p>
               </div>
               
               <div className="absolute bottom-0 right-0 w-full h-[50%] z-10 opacity-90 group-hover:opacity-100 transition-all duration-500 rounded-tl-2xl overflow-hidden border-t border-l border-white/10">
                 <img 
            ...
            <div className="md:col-span-6 lg:col-span-12 min-h-[450px] md:h-[500px] bg-gradient-to-br from-[#0b101e] to-emerald-950/20 border border-white/5 rounded-[2rem] p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-10 group">
                ...
                <div className="flex-1 relative z-20 text-center md:text-left order-2 md:order-1">
                    ...
                    <p className="text-slate-400 text-lg mb-8 max-w-lg mx-auto md:mx-0 font-medium leading-relaxed">
                        Use direto pelo navegador do seu celular, rápido e fluido como um aplicativo nativo. Adicione à sua tela inicial com um clique e acesse em segundos, sem ocupar espaço.
                    </p>
                ...
                {/* Mobile Mockup REAL */}
                <div className="flex-1 w-full flex justify-center relative z-10 order-1 md:order-2 mb-8 md:mb-0">
                    <div className="relative w-[260px] h-[520px] md:w-[280px] md:h-[580px] bg-[#020617] border-[8px] border-[#1e293b] rounded-[3rem] shadow-2xl overflow-hidden ring-1 ring-white/10 rotate-[-3deg] group-hover:rotate-0 transition-transform duration-700">
